...
newArray("DeltaF", "Quick DF (no dark current)", "-", "Stimulus Artifact Removal","Extract Stimulus","-",
"Kalman Filter","Registration (Translation)","-","Rotate","SS Caliberate"));
